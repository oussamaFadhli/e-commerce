...
const subCategories = [
  ...
  { name: "Console", to: "/consoles" },
  { name: "Gaming Accessories", to: "/gaming-accessories" },
  { name: "Monitors", to: "/monitors" },
  { name: "Stockage", to: "/stockage" },
  { name: "Softwares", to: "/softwares" },
];
const filters = [
  {
    id: "brand",
  ...
  },
  {
    ...
    options: [
      ...
      { value: "i7", label: "i7", checked: false },
    ],
  },
  {
    id: "ram",
    name: "RAM",
    options: [
      { value: "4", label: "4 GO", checked: false },
      { value: "8", label: "8 GO", checked: true },
      { value: "16", label: "16 GO", checked: false },
      { value: "32", label: "32 GO", checked: false },
      { value: "64", label: "64 GO", checked: false },
    ],
  },
  {
    id: "stockage",
    name: "Stockage",
    options: [
      { value: "120", label: "120 GO", checked: true },
      { value: "256", label: "256 GO", checked: false },
      { value: "512", label: "512 GO", checked: false },
      { value: "960", label: "960 GO", checked: false },
    ],
  },
  {
    id: "stock",
    name: "Stock",
    options: [
      { value: "on-stock", label: "On Stock", checked: true },
      { value: "out-stock", label: "Out Stock", checked: false },
    ],
  },
];
...
const ProductsFiltersLayout = ({children}) => {
...
export default ProductsFiltersLayout